...
import { CreateAvatarCommand, UpdateAvatarCommand } from './commands/impl';
...
export class AvatarsService {
  ...
  async updateAvatar(data: {
    ...
    this.logger.log(`Executing UpdateAvatarCommand with URL ${url}...`);

    return this.commandBus.execute<UpdateAvatarCommand, void>(
