...
export namespace validate {
  ...
  export class FieldRules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_message)
        writer.writeMessage(17, this.message, () =>
          this.message.serialize(writer),
        );
      if (this.has_float)
        writer.writeMessage(1, this.float, () => this.float.serialize(writer));
      if (this.has_double)
        writer.writeMessage(2, this.double, () =>
          this.double.serialize(writer),
        );
      if (this.has_int32)
      ...
      if (this.has_uint32)
        writer.writeMessage(5, this.uint32, () =>
          this.uint32.serialize(writer),
        );
      if (this.has_uint64)
        writer.writeMessage(6, this.uint64, () =>
          this.uint64.serialize(writer),
        );
      if (this.has_sint32)
        writer.writeMessage(7, this.sint32, () =>
          this.sint32.serialize(writer),
        );
      if (this.has_sint64)
        writer.writeMessage(8, this.sint64, () =>
          this.sint64.serialize(writer),
        );
      if (this.has_fixed32)
        writer.writeMessage(9, this.fixed32, () =>
          this.fixed32.serialize(writer),
        );
      if (this.has_fixed64)
        writer.writeMessage(10, this.fixed64, () =>
          this.fixed64.serialize(writer),
        );
      if (this.has_sfixed32)
        writer.writeMessage(11, this.sfixed32, () =>
          this.sfixed32.serialize(writer),
        );
      if (this.has_sfixed64)
        writer.writeMessage(12, this.sfixed64, () =>
          this.sfixed64.serialize(writer),
        );
      if (this.has_bool)
        writer.writeMessage(13, this.bool, () => this.bool.serialize(writer));
      if (this.has_string)
        writer.writeMessage(14, this.string, () =>
          this.string.serialize(writer),
        );
      if (this.has_bytes)
      ...
      if (this.has_repeated)
        writer.writeMessage(18, this.repeated, () =>
          this.repeated.serialize(writer),
        );
      if (this.has_map)
      ...
      if (this.has_duration)
        writer.writeMessage(21, this.duration, () =>
          this.duration.serialize(writer),
        );
      if (this.has_timestamp)
        writer.writeMessage(22, this.timestamp, () =>
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 17:
            reader.readMessage(
              message.message,
              () => (message.message = MessageRules.deserialize(reader)),
            );
            break;
          case 1:
            reader.readMessage(
              message.float,
              () => (message.float = FloatRules.deserialize(reader)),
            );
            break;
          case 2:
            reader.readMessage(
              message.double,
              () => (message.double = DoubleRules.deserialize(reader)),
            );
            break;
          case 3:
            reader.readMessage(
              message.int32,
              () => (message.int32 = Int32Rules.deserialize(reader)),
            );
            break;
          case 4:
            reader.readMessage(
              message.int64,
              () => (message.int64 = Int64Rules.deserialize(reader)),
            );
            break;
          case 5:
            reader.readMessage(
              message.uint32,
              () => (message.uint32 = UInt32Rules.deserialize(reader)),
            );
            break;
          case 6:
            reader.readMessage(
              message.uint64,
              () => (message.uint64 = UInt64Rules.deserialize(reader)),
            );
            break;
          case 7:
            reader.readMessage(
              message.sint32,
              () => (message.sint32 = SInt32Rules.deserialize(reader)),
            );
            break;
          case 8:
            reader.readMessage(
              message.sint64,
              () => (message.sint64 = SInt64Rules.deserialize(reader)),
            );
            break;
          case 9:
            reader.readMessage(
              message.fixed32,
              () => (message.fixed32 = Fixed32Rules.deserialize(reader)),
            );
            break;
          case 10:
            reader.readMessage(
              message.fixed64,
              () => (message.fixed64 = Fixed64Rules.deserialize(reader)),
            );
            break;
          case 11:
            reader.readMessage(
              message.sfixed32,
              () => (message.sfixed32 = SFixed32Rules.deserialize(reader)),
            );
            break;
          case 12:
            reader.readMessage(
              message.sfixed64,
              () => (message.sfixed64 = SFixed64Rules.deserialize(reader)),
            );
            break;
          case 13:
            reader.readMessage(
              message.bool,
              () => (message.bool = BoolRules.deserialize(reader)),
            );
            break;
          case 14:
            reader.readMessage(
              message.string,
              () => (message.string = StringRules.deserialize(reader)),
            );
            break;
          case 15:
            reader.readMessage(
              message.bytes,
              () => (message.bytes = BytesRules.deserialize(reader)),
            );
            break;
          case 16:
            reader.readMessage(
              message.enum,
              () => (message.enum = EnumRules.deserialize(reader)),
            );
            break;
          case 18:
            reader.readMessage(
              message.repeated,
              () => (message.repeated = RepeatedRules.deserialize(reader)),
            );
            break;
          case 19:
            reader.readMessage(
              message.map,
              () => (message.map = MapRules.deserialize(reader)),
            );
            break;
          case 20:
            reader.readMessage(
              message.any,
              () => (message.any = AnyRules.deserialize(reader)),
            );
            break;
          case 21:
            reader.readMessage(
              message.duration,
              () => (message.duration = DurationRules.deserialize(reader)),
            );
            break;
          case 22:
            reader.readMessage(
              message.timestamp,
              () => (message.timestamp = TimestampRules.deserialize(reader)),
            );
            break;
          default:
            reader.skipField();
  ...
  export class FloatRules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeFloat(1, this.const);
      if (this.has_lt) writer.writeFloat(2, this.lt);
      if (this.has_lte) writer.writeFloat(3, this.lte);
      if (this.has_gt) writer.writeFloat(4, this.gt);
      if (this.has_gte) writer.writeFloat(5, this.gte);
      if (this.in.length) writer.writeRepeatedFloat(6, this.in);
      if (this.not_in.length) writer.writeRepeatedFloat(7, this.not_in);
      if (this.has_ignore_empty) writer.writeBool(8, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class DoubleRules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeDouble(1, this.const);
      if (this.has_lt) writer.writeDouble(2, this.lt);
      if (this.has_lte) writer.writeDouble(3, this.lte);
      if (this.has_gt) writer.writeDouble(4, this.gt);
      if (this.has_gte) writer.writeDouble(5, this.gte);
      if (this.in.length) writer.writeRepeatedDouble(6, this.in);
      if (this.not_in.length) writer.writeRepeatedDouble(7, this.not_in);
      if (this.has_ignore_empty) writer.writeBool(8, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class Int32Rules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeInt32(1, this.const);
      if (this.has_lt) writer.writeInt32(2, this.lt);
      if (this.has_lte) writer.writeInt32(3, this.lte);
      if (this.has_gt) writer.writeInt32(4, this.gt);
      if (this.has_gte) writer.writeInt32(5, this.gte);
      if (this.in.length) writer.writeRepeatedInt32(6, this.in);
      if (this.not_in.length) writer.writeRepeatedInt32(7, this.not_in);
      if (this.has_ignore_empty) writer.writeBool(8, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class Int64Rules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeInt64(1, this.const);
      if (this.has_lt) writer.writeInt64(2, this.lt);
      if (this.has_lte) writer.writeInt64(3, this.lte);
      if (this.has_gt) writer.writeInt64(4, this.gt);
      if (this.has_gte) writer.writeInt64(5, this.gte);
      if (this.in.length) writer.writeRepeatedInt64(6, this.in);
      if (this.not_in.length) writer.writeRepeatedInt64(7, this.not_in);
      if (this.has_ignore_empty) writer.writeBool(8, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class UInt32Rules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeUint32(1, this.const);
      if (this.has_lt) writer.writeUint32(2, this.lt);
      if (this.has_lte) writer.writeUint32(3, this.lte);
      if (this.has_gt) writer.writeUint32(4, this.gt);
      if (this.has_gte) writer.writeUint32(5, this.gte);
      if (this.in.length) writer.writeRepeatedUint32(6, this.in);
      if (this.not_in.length) writer.writeRepeatedUint32(7, this.not_in);
      if (this.has_ignore_empty) writer.writeBool(8, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class UInt64Rules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeUint64(1, this.const);
      if (this.has_lt) writer.writeUint64(2, this.lt);
      if (this.has_lte) writer.writeUint64(3, this.lte);
      if (this.has_gt) writer.writeUint64(4, this.gt);
      if (this.has_gte) writer.writeUint64(5, this.gte);
      if (this.in.length) writer.writeRepeatedUint64(6, this.in);
      if (this.not_in.length) writer.writeRepeatedUint64(7, this.not_in);
      if (this.has_ignore_empty) writer.writeBool(8, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class SInt32Rules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeSint32(1, this.const);
      if (this.has_lt) writer.writeSint32(2, this.lt);
      if (this.has_lte) writer.writeSint32(3, this.lte);
      if (this.has_gt) writer.writeSint32(4, this.gt);
      if (this.has_gte) writer.writeSint32(5, this.gte);
      if (this.in.length) writer.writeRepeatedSint32(6, this.in);
      if (this.not_in.length) writer.writeRepeatedSint32(7, this.not_in);
      if (this.has_ignore_empty) writer.writeBool(8, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class SInt64Rules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeSint64(1, this.const);
      if (this.has_lt) writer.writeSint64(2, this.lt);
      if (this.has_lte) writer.writeSint64(3, this.lte);
      if (this.has_gt) writer.writeSint64(4, this.gt);
      if (this.has_gte) writer.writeSint64(5, this.gte);
      if (this.in.length) writer.writeRepeatedSint64(6, this.in);
      if (this.not_in.length) writer.writeRepeatedSint64(7, this.not_in);
      if (this.has_ignore_empty) writer.writeBool(8, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class Fixed32Rules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeFixed32(1, this.const);
      if (this.has_lt) writer.writeFixed32(2, this.lt);
      if (this.has_lte) writer.writeFixed32(3, this.lte);
      if (this.has_gt) writer.writeFixed32(4, this.gt);
      if (this.has_gte) writer.writeFixed32(5, this.gte);
      if (this.in.length) writer.writeRepeatedFixed32(6, this.in);
      if (this.not_in.length) writer.writeRepeatedFixed32(7, this.not_in);
      if (this.has_ignore_empty) writer.writeBool(8, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class Fixed64Rules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeFixed64(1, this.const);
      if (this.has_lt) writer.writeFixed64(2, this.lt);
      if (this.has_lte) writer.writeFixed64(3, this.lte);
      if (this.has_gt) writer.writeFixed64(4, this.gt);
      if (this.has_gte) writer.writeFixed64(5, this.gte);
      if (this.in.length) writer.writeRepeatedFixed64(6, this.in);
      if (this.not_in.length) writer.writeRepeatedFixed64(7, this.not_in);
      if (this.has_ignore_empty) writer.writeBool(8, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class SFixed32Rules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeSfixed32(1, this.const);
      if (this.has_lt) writer.writeSfixed32(2, this.lt);
      if (this.has_lte) writer.writeSfixed32(3, this.lte);
      if (this.has_gt) writer.writeSfixed32(4, this.gt);
      if (this.has_gte) writer.writeSfixed32(5, this.gte);
      if (this.in.length) writer.writeRepeatedSfixed32(6, this.in);
      if (this.not_in.length) writer.writeRepeatedSfixed32(7, this.not_in);
      if (this.has_ignore_empty) writer.writeBool(8, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class SFixed64Rules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeSfixed64(1, this.const);
      if (this.has_lt) writer.writeSfixed64(2, this.lt);
      if (this.has_lte) writer.writeSfixed64(3, this.lte);
      if (this.has_gt) writer.writeSfixed64(4, this.gt);
      if (this.has_gte) writer.writeSfixed64(5, this.gte);
      if (this.in.length) writer.writeRepeatedSfixed64(6, this.in);
      if (this.not_in.length) writer.writeRepeatedSfixed64(7, this.not_in);
      if (this.has_ignore_empty) writer.writeBool(8, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class BoolRules extends pb_1.Message {
    ...
    static fromObject(data: { const?: boolean }): BoolRules {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeBool(1, this.const);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class StringRules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_len) writer.writeUint64(19, this.len);
      if (this.has_min_len) writer.writeUint64(2, this.min_len);
      if (this.has_max_len) writer.writeUint64(3, this.max_len);
      if (this.has_len_bytes) writer.writeUint64(20, this.len_bytes);
      if (this.has_min_bytes) writer.writeUint64(4, this.min_bytes);
      if (this.has_max_bytes) writer.writeUint64(5, this.max_bytes);
      ...
      if (this.in.length) writer.writeRepeatedString(10, this.in);
      if (this.not_in.length) writer.writeRepeatedString(11, this.not_in);
      if (this.has_email) writer.writeBool(12, this.email);
      if (this.has_hostname) writer.writeBool(13, this.hostname);
      if (this.has_ip) writer.writeBool(14, this.ip);
      if (this.has_ipv4) writer.writeBool(15, this.ipv4);
      if (this.has_ipv6) writer.writeBool(16, this.ipv6);
      if (this.has_uri) writer.writeBool(17, this.uri);
      if (this.has_uri_ref) writer.writeBool(18, this.uri_ref);
      if (this.has_address) writer.writeBool(21, this.address);
      if (this.has_uuid) writer.writeBool(22, this.uuid);
      if (this.has_well_known_regex)
        writer.writeEnum(24, this.well_known_regex);
      if (this.has_strict) writer.writeBool(25, this.strict);
      if (this.has_ignore_empty) writer.writeBool(26, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class BytesRules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const && this.const.length) writer.writeBytes(1, this.const);
      if (this.has_len) writer.writeUint64(13, this.len);
      if (this.has_min_len) writer.writeUint64(2, this.min_len);
      if (this.has_max_len) writer.writeUint64(3, this.max_len);
      if (this.has_pattern && this.pattern.length)
      ...
      if (this.in.length) writer.writeRepeatedBytes(8, this.in);
      if (this.not_in.length) writer.writeRepeatedBytes(9, this.not_in);
      if (this.has_ip) writer.writeBool(10, this.ip);
      if (this.has_ipv4) writer.writeBool(11, this.ipv4);
      if (this.has_ipv6) writer.writeBool(12, this.ipv6);
      if (this.has_ignore_empty) writer.writeBool(14, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class EnumRules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_const) writer.writeInt32(1, this.const);
      if (this.has_defined_only) writer.writeBool(2, this.defined_only);
      if (this.in.length) writer.writeRepeatedInt32(3, this.in);
      if (this.not_in.length) writer.writeRepeatedInt32(4, this.not_in);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class MessageRules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_skip) writer.writeBool(1, this.skip);
      if (this.has_required) writer.writeBool(2, this.required);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class RepeatedRules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_min_items) writer.writeUint64(1, this.min_items);
      if (this.has_max_items) writer.writeUint64(2, this.max_items);
      if (this.has_unique) writer.writeBool(3, this.unique);
      if (this.has_items)
        writer.writeMessage(4, this.items, () => this.items.serialize(writer));
      if (this.has_ignore_empty) writer.writeBool(5, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 4:
            reader.readMessage(
              message.items,
              () => (message.items = FieldRules.deserialize(reader)),
            );
            break;
          case 5:
            message.ignore_empty = reader.readBool();
  ...
  export class MapRules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_min_pairs) writer.writeUint64(1, this.min_pairs);
      if (this.has_max_pairs) writer.writeUint64(2, this.max_pairs);
      if (this.has_no_sparse) writer.writeBool(3, this.no_sparse);
      if (this.has_keys)
      ...
      if (this.has_ignore_empty) writer.writeBool(6, this.ignore_empty);
      if (!w) return writer.getResultBuffer();
    }
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 4:
            reader.readMessage(
              message.keys,
              () => (message.keys = FieldRules.deserialize(reader)),
            );
            break;
          case 5:
            reader.readMessage(
              message.values,
              () => (message.values = FieldRules.deserialize(reader)),
            );
            break;
          case 6:
            message.ignore_empty = reader.readBool();
  ...
  export class AnyRules extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_required) writer.writeBool(1, this.required);
      if (this.in.length) writer.writeRepeatedString(2, this.in);
      if (this.not_in.length) writer.writeRepeatedString(3, this.not_in);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class DurationRules extends pb_1.Message {
    ...
    get const() {
      return pb_1.Message.getWrapperField(
        this,
        dependency_2.google.protobuf.Duration,
        2,
      ) as dependency_2.google.protobuf.Duration;
    }
    ...
    static fromObject(data: {
      required?: boolean;
      const?: ReturnType<
        typeof dependency_2.google.protobuf.Duration.prototype.toObject
      >;
      lt?: ReturnType<
        typeof dependency_2.google.protobuf.Duration.prototype.toObject
      >;
      ...
      const message = new DurationRules({
        in: data.in.map((item) =>
          dependency_2.google.protobuf.Duration.fromObject(item),
        ),
        not_in: data.not_in.map((item) =>
          dependency_2.google.protobuf.Duration.fromObject(item),
        ),
      });
      if (data.required != null) {
      ...
      if (data.const != null) {
        message.const = dependency_2.google.protobuf.Duration.fromObject(
          data.const,
        );
      }
      if (data.lt != null) {
      ...
      if (data.lte != null) {
        message.lte = dependency_2.google.protobuf.Duration.fromObject(
          data.lte,
        );
      }
      if (data.gt != null) {
      ...
      if (data.gte != null) {
        message.gte = dependency_2.google.protobuf.Duration.fromObject(
          data.gte,
        );
      }
      return message;
    ...
    toObject() {
      ...
      if (this.in != null) {
        data.in = this.in.map((item: dependency_2.google.protobuf.Duration) =>
          item.toObject(),
        );
      }
      if (this.not_in != null) {
        data.not_in = this.not_in.map(
          (item: dependency_2.google.protobuf.Duration) => item.toObject(),
        );
      }
      return data;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.in.length)
        writer.writeRepeatedMessage(
          7,
          this.in,
          (item: dependency_2.google.protobuf.Duration) =>
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 2:
            reader.readMessage(
              ...
              () =>
                (message.const =
                  dependency_2.google.protobuf.Duration.deserialize(reader)),
            );
            break;
          case 3:
            reader.readMessage(
          ...
          case 7:
            ...
            break;
          case 8:
            reader.readMessage(message.not_in, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                8,
                dependency_2.google.protobuf.Duration.deserialize(reader),
  ...
  export class TimestampRules extends pb_1.Message {
    ...
    get const() {
      return pb_1.Message.getWrapperField(
        this,
        dependency_3.google.protobuf.Timestamp,
        2,
      ) as dependency_3.google.protobuf.Timestamp;
    }
    ...
    static fromObject(data: {
      required?: boolean;
      const?: ReturnType<
        typeof dependency_3.google.protobuf.Timestamp.prototype.toObject
      >;
      lt?: ReturnType<
        typeof dependency_3.google.protobuf.Timestamp.prototype.toObject
      >;
      ...
      if (data.const != null) {
        message.const = dependency_3.google.protobuf.Timestamp.fromObject(
          data.const,
        );
      }
      if (data.lt != null) {
      ...
      if (data.lte != null) {
        message.lte = dependency_3.google.protobuf.Timestamp.fromObject(
          data.lte,
        );
      }
      if (data.gt != null) {
      ...
      if (data.gte != null) {
        message.gte = dependency_3.google.protobuf.Timestamp.fromObject(
          data.gte,
        );
      }
      if (data.lt_now != null) {
      ...
      if (data.within != null) {
        message.within = dependency_2.google.protobuf.Duration.fromObject(
          data.within,
        );
      }
      return message;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_gte)
        writer.writeMessage(6, this.gte, () => this.gte.serialize(writer));
      if (this.has_lt_now) writer.writeBool(7, this.lt_now);
      if (this.has_gt_now) writer.writeBool(8, this.gt_now);
      if (this.has_within)
        writer.writeMessage(9, this.within, () =>
          this.within.serialize(writer),
        );
      if (!w) return writer.getResultBuffer();
    }
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 2:
            reader.readMessage(
              ...
              () =>
                (message.const =
                  dependency_3.google.protobuf.Timestamp.deserialize(reader)),
            );
            break;
          case 3:
            reader.readMessage(
