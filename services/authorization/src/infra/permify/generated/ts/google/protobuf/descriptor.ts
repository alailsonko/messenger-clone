...
export namespace google.protobuf {
  ...
  export class FileDescriptorSet extends pb_1.Message {
    ...
    toObject() {
      ...
      if (this.file != null) {
        data.file = this.file.map((item: FileDescriptorProto) =>
          item.toObject(),
        );
      }
      return data;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.file.length)
        writer.writeRepeatedMessage(1, this.file, (item: FileDescriptorProto) =>
    ...
    static deserialize(
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 1:
            reader.readMessage(message.file, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                1,
                FileDescriptorProto.deserialize(reader),
                FileDescriptorProto,
              ),
            );
            break;
  ...
  export class FileDescriptorProto extends pb_1.Message {
    ...
    static fromObject(data: {
      ...
      const message = new FileDescriptorProto({
        ...
        message_type: data.message_type.map((item) =>
          DescriptorProto.fromObject(item),
        ),
        enum_type: data.enum_type.map((item) =>
          EnumDescriptorProto.fromObject(item),
        ),
        service: data.service.map((item) =>
          ServiceDescriptorProto.fromObject(item),
        ),
        extension: data.extension.map((item) =>
          FieldDescriptorProto.fromObject(item),
        ),
      });
      if (data.name != null) {
      ...
      if (data.source_code_info != null) {
        message.source_code_info = SourceCodeInfo.fromObject(
          data.source_code_info,
        );
      }
      if (data.syntax != null) {
    ...
    toObject() {
      const data: {
        ...
        enum_type?: ReturnType<typeof EnumDescriptorProto.prototype.toObject>[];
        service?: ReturnType<
          typeof ServiceDescriptorProto.prototype.toObject
        >[];
        extension?: ReturnType<
          typeof FieldDescriptorProto.prototype.toObject
        >[];
        options?: ReturnType<typeof FileOptions.prototype.toObject>;
        source_code_info?: ReturnType<typeof SourceCodeInfo.prototype.toObject>;
        syntax?: string;
      ...
      if (this.message_type != null) {
        data.message_type = this.message_type.map((item: DescriptorProto) =>
          item.toObject(),
        );
      }
      if (this.enum_type != null) {
        data.enum_type = this.enum_type.map((item: EnumDescriptorProto) =>
          item.toObject(),
        );
      }
      if (this.service != null) {
        data.service = this.service.map((item: ServiceDescriptorProto) =>
          item.toObject(),
        );
      }
      if (this.extension != null) {
        data.extension = this.extension.map((item: FieldDescriptorProto) =>
          item.toObject(),
        );
      }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.message_type.length)
        writer.writeRepeatedMessage(
          4,
          this.message_type,
          (item: DescriptorProto) => item.serialize(writer),
        );
      if (this.enum_type.length)
        writer.writeRepeatedMessage(
          5,
          this.enum_type,
          (item: EnumDescriptorProto) => item.serialize(writer),
        );
      if (this.service.length)
        writer.writeRepeatedMessage(
          6,
          this.service,
          (item: ServiceDescriptorProto) => item.serialize(writer),
        );
      if (this.extension.length)
        writer.writeRepeatedMessage(
          7,
          this.extension,
          (item: FieldDescriptorProto) => item.serialize(writer),
        );
      if (this.has_options)
        writer.writeMessage(8, this.options, () =>
          this.options.serialize(writer),
        );
      if (this.has_source_code_info)
        writer.writeMessage(9, this.source_code_info, () =>
          this.source_code_info.serialize(writer),
        );
      if (this.has_syntax && this.syntax.length)
        writer.writeString(12, this.syntax);
      if (this.has_edition) writer.writeEnum(14, this.edition);
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(
      bytes: Uint8Array | pb_1.BinaryReader,
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 11:
            ...
            break;
          case 4:
            reader.readMessage(message.message_type, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                4,
                DescriptorProto.deserialize(reader),
                DescriptorProto,
              ),
            );
            break;
          case 5:
            reader.readMessage(message.enum_type, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                5,
                EnumDescriptorProto.deserialize(reader),
                EnumDescriptorProto,
              ),
            );
            break;
          case 6:
            reader.readMessage(message.service, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                6,
                ServiceDescriptorProto.deserialize(reader),
                ServiceDescriptorProto,
              ),
            );
            break;
          case 7:
            reader.readMessage(message.extension, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                7,
                FieldDescriptorProto.deserialize(reader),
                FieldDescriptorProto,
              ),
            );
            break;
          case 8:
            reader.readMessage(
              message.options,
              () => (message.options = FileOptions.deserialize(reader)),
            );
            break;
          case 9:
            reader.readMessage(
              ...
              () =>
                (message.source_code_info = SourceCodeInfo.deserialize(reader)),
            );
            break;
          case 12:
  ...
  export class DescriptorProto extends pb_1.Message {
    ...
    get extension_range() {
      return pb_1.Message.getRepeatedWrapperField(
        ...
        5,
      ) as DescriptorProto.ExtensionRange[];
    }
    ...
    get reserved_range() {
      return pb_1.Message.getRepeatedWrapperField(
        ...
        9,
      ) as DescriptorProto.ReservedRange[];
    }
    ...
    static fromObject(data: {
      ...
      enum_type?: ReturnType<typeof EnumDescriptorProto.prototype.toObject>[];
      extension_range?: ReturnType<
        typeof DescriptorProto.ExtensionRange.prototype.toObject
      >[];
      ...
      reserved_range?: ReturnType<
        typeof DescriptorProto.ReservedRange.prototype.toObject
      >[];
      reserved_name: string[];
    }): DescriptorProto {
      const message = new DescriptorProto({
        ...
        nested_type: data.nested_type.map((item) =>
          DescriptorProto.fromObject(item),
        ),
        enum_type: data.enum_type.map((item) =>
          EnumDescriptorProto.fromObject(item),
        ),
        extension_range: data.extension_range.map((item) =>
          DescriptorProto.ExtensionRange.fromObject(item),
        ),
        oneof_decl: data.oneof_decl.map((item) =>
          OneofDescriptorProto.fromObject(item),
        ),
        reserved_range: data.reserved_range.map((item) =>
          DescriptorProto.ReservedRange.fromObject(item),
        ),
    ...
    toObject() {
      const data: {
        ...
        extension_range?: ReturnType<
          typeof DescriptorProto.ExtensionRange.prototype.toObject
        >[];
        oneof_decl?: ReturnType<
          typeof OneofDescriptorProto.prototype.toObject
        >[];
        options?: ReturnType<typeof MessageOptions.prototype.toObject>;
        reserved_range?: ReturnType<
          typeof DescriptorProto.ReservedRange.prototype.toObject
      ...
      if (this.field != null) {
        data.field = this.field.map((item: FieldDescriptorProto) =>
          item.toObject(),
        );
      }
      if (this.extension != null) {
      ...
      if (this.nested_type != null) {
        data.nested_type = this.nested_type.map((item: DescriptorProto) =>
          item.toObject(),
        );
      }
      if (this.enum_type != null) {
      ...
      if (this.extension_range != null) {
        data.extension_range = this.extension_range.map(
          (item: DescriptorProto.ExtensionRange) => item.toObject(),
        );
      }
      if (this.oneof_decl != null) {
        data.oneof_decl = this.oneof_decl.map((item: OneofDescriptorProto) =>
          item.toObject(),
        );
      }
      if (this.options != null) {
      ...
      if (this.reserved_range != null) {
        data.reserved_range = this.reserved_range.map(
          (item: DescriptorProto.ReservedRange) => item.toObject(),
        );
      }
      return data;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.extension_range.length)
        writer.writeRepeatedMessage(
          ...
          (item: DescriptorProto.ExtensionRange) => item.serialize(writer),
        );
      if (this.oneof_decl.length)
        writer.writeRepeatedMessage(
          8,
          this.oneof_decl,
          (item: OneofDescriptorProto) => item.serialize(writer),
        );
      if (this.has_options)
      ...
      if (this.reserved_range.length)
        writer.writeRepeatedMessage(
          9,
          this.reserved_range,
          (item: DescriptorProto.ReservedRange) => item.serialize(writer),
        );
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 1:
            ...
            break;
          case 2:
            reader.readMessage(message.field, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                2,
                FieldDescriptorProto.deserialize(reader),
          ...
          case 6:
            ...
            break;
          case 3:
            reader.readMessage(message.nested_type, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                3,
                DescriptorProto.deserialize(reader),
          ...
          case 4:
            ...
            break;
          case 5:
            reader.readMessage(message.extension_range, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                5,
                DescriptorProto.ExtensionRange.deserialize(reader),
                DescriptorProto.ExtensionRange,
              ),
            );
            break;
          case 8:
            reader.readMessage(message.oneof_decl, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                8,
                OneofDescriptorProto.deserialize(reader),
                OneofDescriptorProto,
              ),
            );
            break;
          case 7:
            reader.readMessage(
              message.options,
              () => (message.options = MessageOptions.deserialize(reader)),
            );
            break;
          case 9:
            reader.readMessage(message.reserved_range, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                9,
                DescriptorProto.ReservedRange.deserialize(reader),
                DescriptorProto.ReservedRange,
              ),
            );
            break;
  ...
  export namespace DescriptorProto {
    export class ExtensionRange extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.has_start) writer.writeInt32(1, this.start);
        if (this.has_end) writer.writeInt32(2, this.end);
        if (this.has_options)
          ...
          switch (reader.getFieldNumber()) {
            ...
            case 3:
              reader.readMessage(
                message.options,
                () =>
                  (message.options = ExtensionRangeOptions.deserialize(reader)),
              );
              break;
            default:
              reader.skipField();
    ...
    export class ReservedRange extends pb_1.Message {
      ...
      static fromObject(data: { start?: number; end?: number }): ReservedRange {
  ...
  export class ExtensionRangeOptions extends pb_1.Message {
    ...
    get declaration() {
      return pb_1.Message.getRepeatedWrapperField(
        ...
        2,
      ) as ExtensionRangeOptions.Declaration[];
    }
    ...
    static fromObject(data: {
      uninterpreted_option?: ReturnType<
        typeof UninterpretedOption.prototype.toObject
      >[];
      declaration?: ReturnType<
        typeof ExtensionRangeOptions.Declaration.prototype.toObject
      >[];
      features?: ReturnType<typeof FeatureSet.prototype.toObject>;
      verification?: ExtensionRangeOptions.VerificationState;
    }): ExtensionRangeOptions {
      const message = new ExtensionRangeOptions({
        uninterpreted_option: data.uninterpreted_option.map((item) =>
          UninterpretedOption.fromObject(item),
        ),
        declaration: data.declaration.map((item) =>
          ExtensionRangeOptions.Declaration.fromObject(item),
        ),
      });
    ...
    toObject() {
      ...
      if (this.uninterpreted_option != null) {
        data.uninterpreted_option = this.uninterpreted_option.map(
          (item: UninterpretedOption) => item.toObject(),
        );
      }
      if (this.declaration != null) {
        data.declaration = this.declaration.map(
          (item: ExtensionRangeOptions.Declaration) => item.toObject(),
        );
      }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.uninterpreted_option.length)
        writer.writeRepeatedMessage(
          ...
          (item: UninterpretedOption) => item.serialize(writer),
        );
      if (this.declaration.length)
        writer.writeRepeatedMessage(
          2,
          this.declaration,
          (item: ExtensionRangeOptions.Declaration) => item.serialize(writer),
        );
      if (this.has_features)
        writer.writeMessage(50, this.features, () =>
          this.features.serialize(writer),
        );
      if (this.has_verification) writer.writeEnum(3, this.verification);
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(
      bytes: Uint8Array | pb_1.BinaryReader,
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 999:
            reader.readMessage(message.uninterpreted_option, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                999,
                UninterpretedOption.deserialize(reader),
                UninterpretedOption,
              ),
            );
            break;
          case 2:
            reader.readMessage(message.declaration, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                2,
                ExtensionRangeOptions.Declaration.deserialize(reader),
                ExtensionRangeOptions.Declaration,
              ),
            );
            break;
          case 50:
            reader.readMessage(
              message.features,
              () => (message.features = FeatureSet.deserialize(reader)),
            );
            break;
          case 3:
  ...
  export namespace ExtensionRangeOptions {
    ...
    export class Declaration extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.has_number) writer.writeInt32(1, this.number);
        if (this.has_full_name && this.full_name.length)
          writer.writeString(2, this.full_name);
        if (this.has_type && this.type.length) writer.writeString(3, this.type);
        if (this.has_reserved) writer.writeBool(5, this.reserved);
        if (this.has_repeated) writer.writeBool(6, this.repeated);
        if (!w) return writer.getResultBuffer();
      }
  ...
  export class FieldDescriptorProto extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_name && this.name.length) writer.writeString(1, this.name);
      if (this.has_number) writer.writeInt32(3, this.number);
      if (this.has_label) writer.writeEnum(4, this.label);
      if (this.has_type) writer.writeEnum(5, this.type);
      ...
      if (this.has_oneof_index) writer.writeInt32(9, this.oneof_index);
      ...
      if (this.has_proto3_optional) writer.writeBool(17, this.proto3_optional);
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(
      bytes: Uint8Array | pb_1.BinaryReader,
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 8:
            reader.readMessage(
              message.options,
              () => (message.options = FieldOptions.deserialize(reader)),
            );
            break;
          case 17:
  ...
  export class OneofDescriptorProto extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_name && this.name.length) writer.writeString(1, this.name);
      if (this.has_options)
        writer.writeMessage(2, this.options, () =>
          this.options.serialize(writer),
        );
      if (!w) return writer.getResultBuffer();
    }
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 2:
            reader.readMessage(
              message.options,
              () => (message.options = OneofOptions.deserialize(reader)),
            );
            break;
          default:
            reader.skipField();
  ...
  export class EnumDescriptorProto extends pb_1.Message {
    ...
    get reserved_range() {
      return pb_1.Message.getRepeatedWrapperField(
        ...
        4,
      ) as EnumDescriptorProto.EnumReservedRange[];
    }
    ...
    static fromObject(data: {
      ...
      reserved_range?: ReturnType<
        typeof EnumDescriptorProto.EnumReservedRange.prototype.toObject
      >[];
      reserved_name: string[];
    }): EnumDescriptorProto {
      const message = new EnumDescriptorProto({
        value: data.value.map((item) =>
          EnumValueDescriptorProto.fromObject(item),
        ),
        reserved_range: data.reserved_range.map((item) =>
          EnumDescriptorProto.EnumReservedRange.fromObject(item),
        ),
        reserved_name: data.reserved_name,
      });
      if (data.name != null) {
    ...
    toObject() {
      const data: {
        name?: string;
        value?: ReturnType<
          typeof EnumValueDescriptorProto.prototype.toObject
        >[];
        options?: ReturnType<typeof EnumOptions.prototype.toObject>;
        reserved_range?: ReturnType<
          typeof EnumDescriptorProto.EnumReservedRange.prototype.toObject
      ...
      if (this.value != null) {
        data.value = this.value.map((item: EnumValueDescriptorProto) =>
          item.toObject(),
        );
      }
      if (this.options != null) {
      ...
      if (this.reserved_range != null) {
        data.reserved_range = this.reserved_range.map(
          (item: EnumDescriptorProto.EnumReservedRange) => item.toObject(),
        );
      }
      return data;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.value.length)
        writer.writeRepeatedMessage(
          2,
          this.value,
          (item: EnumValueDescriptorProto) => item.serialize(writer),
        );
      if (this.has_options)
        writer.writeMessage(3, this.options, () =>
          this.options.serialize(writer),
      ...
      if (this.reserved_range.length)
        writer.writeRepeatedMessage(
          4,
          this.reserved_range,
          (item: EnumDescriptorProto.EnumReservedRange) =>
            item.serialize(writer),
        );
      if (this.reserved_name.length)
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 1:
            ...
            break;
          case 2:
            reader.readMessage(message.value, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                2,
                EnumValueDescriptorProto.deserialize(reader),
                EnumValueDescriptorProto,
              ),
            );
            break;
          case 3:
            reader.readMessage(
              message.options,
              () => (message.options = EnumOptions.deserialize(reader)),
            );
            break;
          case 4:
            reader.readMessage(message.reserved_range, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                4,
                EnumDescriptorProto.EnumReservedRange.deserialize(reader),
                EnumDescriptorProto.EnumReservedRange,
              ),
            );
            break;
  ...
  export class EnumValueDescriptorProto extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_name && this.name.length) writer.writeString(1, this.name);
      if (this.has_number) writer.writeInt32(2, this.number);
      if (this.has_options)
        writer.writeMessage(3, this.options, () =>
          this.options.serialize(writer),
        );
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 3:
            reader.readMessage(
              message.options,
              () => (message.options = EnumValueOptions.deserialize(reader)),
            );
            break;
          default:
            reader.skipField();
  ...
  export class ServiceDescriptorProto extends pb_1.Message {
    ...
    static fromObject(data: {
      ...
      const message = new ServiceDescriptorProto({
        method: data.method.map((item) =>
          MethodDescriptorProto.fromObject(item),
        ),
      });
      if (data.name != null) {
        message.name = data.name;
    ...
    toObject() {
      ...
      if (this.method != null) {
        data.method = this.method.map((item: MethodDescriptorProto) =>
          item.toObject(),
        );
      }
      if (this.options != null) {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.method.length)
        writer.writeRepeatedMessage(
          2,
          this.method,
          (item: MethodDescriptorProto) => item.serialize(writer),
        );
      if (this.has_options)
        writer.writeMessage(3, this.options, () =>
          this.options.serialize(writer),
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 1:
            ...
            break;
          case 2:
            reader.readMessage(message.method, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                2,
                MethodDescriptorProto.deserialize(reader),
                MethodDescriptorProto,
              ),
            );
            break;
          case 3:
            reader.readMessage(
              message.options,
              () => (message.options = ServiceOptions.deserialize(reader)),
            );
            break;
          default:
            reader.skipField();
  ...
  export class MethodDescriptorProto extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_options)
        writer.writeMessage(4, this.options, () =>
          this.options.serialize(writer),
        );
      if (this.has_client_streaming) writer.writeBool(5, this.client_streaming);
      if (this.has_server_streaming) writer.writeBool(6, this.server_streaming);
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(
      bytes: Uint8Array | pb_1.BinaryReader,
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 4:
            reader.readMessage(
              message.options,
              () => (message.options = MethodOptions.deserialize(reader)),
            );
            break;
          case 5:
  ...
  export class FileOptions extends pb_1.Message {
    ...
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == 'object') {
        ...
        if (
          'java_outer_classname' in data &&
          data.java_outer_classname != undefined
        ) {
          this.java_outer_classname = data.java_outer_classname;
        }
        if (
          'java_multiple_files' in data &&
          data.java_multiple_files != undefined
        ) {
          this.java_multiple_files = data.java_multiple_files;
        }
        if (
          'java_generate_equals_and_hash' in data &&
        ...
        if (
          'java_string_check_utf8' in data &&
          data.java_string_check_utf8 != undefined
        ) {
        ...
        if (
          'cc_generic_services' in data &&
          data.cc_generic_services != undefined
        ) {
          this.cc_generic_services = data.cc_generic_services;
        }
        if (
          'java_generic_services' in data &&
          data.java_generic_services != undefined
        ) {
          this.java_generic_services = data.java_generic_services;
        }
        if (
          'py_generic_services' in data &&
          data.py_generic_services != undefined
        ) {
        ...
        if (
          'objc_class_prefix' in data &&
          data.objc_class_prefix != undefined
        ) {
        ...
        if (
          'php_metadata_namespace' in data &&
          data.php_metadata_namespace != undefined
        ) {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_optimize_for) writer.writeEnum(9, this.optimize_for);
      ...
      if (this.has_deprecated) writer.writeBool(23, this.deprecated);
  ...
  export class MessageOptions extends pb_1.Message {
    ...
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == 'object') {
        if (
          'message_set_wire_format' in data &&
          data.message_set_wire_format != undefined
        ) {
          this.message_set_wire_format = data.message_set_wire_format;
        }
        if (
          'no_standard_descriptor_accessor' in data &&
          data.no_standard_descriptor_accessor != undefined
        ) {
          this.no_standard_descriptor_accessor =
            data.no_standard_descriptor_accessor;
        }
        if ('deprecated' in data && data.deprecated != undefined) {
          this.deprecated = data.deprecated;
        }
        ...
        if (
          'deprecated_legacy_json_field_conflicts' in data &&
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_deprecated) writer.writeBool(3, this.deprecated);
      if (this.has_map_entry) writer.writeBool(7, this.map_entry);
      if (this.has_deprecated_legacy_json_field_conflicts)
        writer.writeBool(11, this.deprecated_legacy_json_field_conflicts);
      if (this.has_features)
        writer.writeMessage(12, this.features, () =>
          this.features.serialize(writer),
        );
      if (this.uninterpreted_option.length)
        writer.writeRepeatedMessage(
  ...
  export class FieldOptions extends pb_1.Message {
    ...
    get retention() {
      ...
      ) as FieldOptions.OptionRetention;
    }
    ...
    get targets() {
      return pb_1.Message.getFieldWithDefault(
        ...
        19,
        [],
      ) as FieldOptions.OptionTargetType[];
    }
    ...
    get edition_defaults() {
      return pb_1.Message.getRepeatedWrapperField(
        ...
        20,
      ) as FieldOptions.EditionDefault[];
    }
    ...
    static fromObject(data: {
      ...
      retention?: FieldOptions.OptionRetention;
      targets: FieldOptions.OptionTargetType[];
      edition_defaults?: ReturnType<
        typeof FieldOptions.EditionDefault.prototype.toObject
      >[];
      features?: ReturnType<typeof FeatureSet.prototype.toObject>;
      uninterpreted_option?: ReturnType<
        typeof UninterpretedOption.prototype.toObject
      ...
      const message = new FieldOptions({
        ...
        edition_defaults: data.edition_defaults.map((item) =>
          FieldOptions.EditionDefault.fromObject(item),
        ),
        uninterpreted_option: data.uninterpreted_option.map((item) =>
          UninterpretedOption.fromObject(item),
        ),
    ...
    toObject() {
      ...
      if (this.edition_defaults != null) {
        data.edition_defaults = this.edition_defaults.map(
          (item: FieldOptions.EditionDefault) => item.toObject(),
        );
      }
      if (this.features != null) {
        data.features = this.features.toObject();
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_ctype) writer.writeEnum(1, this.ctype);
      if (this.has_packed) writer.writeBool(2, this.packed);
      if (this.has_jstype) writer.writeEnum(6, this.jstype);
      if (this.has_lazy) writer.writeBool(5, this.lazy);
      if (this.has_unverified_lazy) writer.writeBool(15, this.unverified_lazy);
      if (this.has_deprecated) writer.writeBool(3, this.deprecated);
      if (this.has_weak) writer.writeBool(10, this.weak);
      if (this.has_debug_redact) writer.writeBool(16, this.debug_redact);
      if (this.has_retention) writer.writeEnum(17, this.retention);
      if (this.targets.length) writer.writeRepeatedEnum(19, this.targets);
      if (this.edition_defaults.length)
        writer.writeRepeatedMessage(
          20,
          this.edition_defaults,
          (item: FieldOptions.EditionDefault) => item.serialize(writer),
        );
      if (this.has_features)
        writer.writeMessage(21, this.features, () =>
          this.features.serialize(writer),
        );
      if (this.uninterpreted_option.length)
        writer.writeRepeatedMessage(
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 19:
            ...
            break;
          case 20:
            reader.readMessage(message.edition_defaults, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                20,
                FieldOptions.EditionDefault.deserialize(reader),
                FieldOptions.EditionDefault,
              ),
            );
            break;
  ...
  export namespace FieldOptions {
    ...
    export class EditionDefault extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.has_edition) writer.writeEnum(3, this.edition);
  ...
  export class OneofOptions extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_features)
        writer.writeMessage(1, this.features, () =>
          this.features.serialize(writer),
        );
      if (this.uninterpreted_option.length)
        writer.writeRepeatedMessage(
  ...
  export class EnumOptions extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_allow_alias) writer.writeBool(2, this.allow_alias);
      if (this.has_deprecated) writer.writeBool(3, this.deprecated);
      if (this.has_deprecated_legacy_json_field_conflicts)
  ...
  export class EnumValueOptions extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_deprecated) writer.writeBool(1, this.deprecated);
      if (this.has_features)
        writer.writeMessage(2, this.features, () =>
          this.features.serialize(writer),
        );
      if (this.has_debug_redact) writer.writeBool(3, this.debug_redact);
      if (this.uninterpreted_option.length)
        writer.writeRepeatedMessage(
          999,
          this.uninterpreted_option,
  ...
  export class ServiceOptions extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_features)
        writer.writeMessage(34, this.features, () =>
          this.features.serialize(writer),
        );
      if (this.has_deprecated) writer.writeBool(33, this.deprecated);
      if (this.uninterpreted_option.length)
        writer.writeRepeatedMessage(
          999,
          this.uninterpreted_option,
  ...
  export class MethodOptions extends pb_1.Message {
    ...
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == 'object') {
        ...
        if (
          'idempotency_level' in data &&
          data.idempotency_level != undefined
        ) {
    ...
    get idempotency_level() {
      ...
      ) as MethodOptions.IdempotencyLevel;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_features)
        writer.writeMessage(35, this.features, () =>
          this.features.serialize(writer),
        );
      if (this.uninterpreted_option.length)
        writer.writeRepeatedMessage(
  ...
  export class UninterpretedOption extends pb_1.Message {
    ...
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == 'object') {
        ...
        if (
          'positive_int_value' in data &&
          data.positive_int_value != undefined
        ) {
          this.positive_int_value = data.positive_int_value;
        }
        if (
          'negative_int_value' in data &&
          data.negative_int_value != undefined
        ) {
    ...
    get name() {
      return pb_1.Message.getRepeatedWrapperField(
        ...
        2,
      ) as UninterpretedOption.NamePart[];
    }
    ...
    static fromObject(data: {
      name?: ReturnType<
        typeof UninterpretedOption.NamePart.prototype.toObject
      >[];
      identifier_value?: string;
      positive_int_value?: number;
      negative_int_value?: number;
      ...
      const message = new UninterpretedOption({
        name: data.name.map((item) =>
          UninterpretedOption.NamePart.fromObject(item),
        ),
      });
    ...
    toObject() {
      ...
      if (this.name != null) {
        data.name = this.name.map((item: UninterpretedOption.NamePart) =>
          item.toObject(),
        );
      }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.name.length)
        writer.writeRepeatedMessage(
          2,
          this.name,
          (item: UninterpretedOption.NamePart) => item.serialize(writer),
        );
      ...
      if (this.has_double_value) writer.writeDouble(6, this.double_value);
    ...
    static deserialize(
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 2:
            reader.readMessage(message.name, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                2,
                UninterpretedOption.NamePart.deserialize(reader),
                UninterpretedOption.NamePart,
              ),
            );
            break;
  ...
  export namespace UninterpretedOption {
    export class NamePart extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.has_is_extension) writer.writeBool(2, this.is_extension);
        if (!w) return writer.getResultBuffer();
      }
  ...
  export class FeatureSet extends pb_1.Message {
    ...
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == 'object') {
        ...
        if (
          'repeated_field_encoding' in data &&
          data.repeated_field_encoding != undefined
        ) {
    ...
    get repeated_field_encoding() {
      ...
      ) as FeatureSet.RepeatedFieldEncoding;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_field_presence) writer.writeEnum(1, this.field_presence);
      if (this.has_enum_type) writer.writeEnum(2, this.enum_type);
      if (this.has_repeated_field_encoding)
        writer.writeEnum(3, this.repeated_field_encoding);
      if (this.has_utf8_validation) writer.writeEnum(4, this.utf8_validation);
      if (this.has_message_encoding) writer.writeEnum(5, this.message_encoding);
      if (this.has_json_format) writer.writeEnum(6, this.json_format);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class FeatureSetDefaults extends pb_1.Message {
    ...
    get defaults() {
      return pb_1.Message.getRepeatedWrapperField(
        ...
        1,
      ) as FeatureSetDefaults.FeatureSetEditionDefault[];
    }
    ...
    static fromObject(data: {
      defaults?: ReturnType<
        typeof FeatureSetDefaults.FeatureSetEditionDefault.prototype.toObject
      >[];
      minimum_edition?: Edition;
      maximum_edition?: Edition;
    }): FeatureSetDefaults {
      const message = new FeatureSetDefaults({
        defaults: data.defaults.map((item) =>
          FeatureSetDefaults.FeatureSetEditionDefault.fromObject(item),
        ),
      });
    ...
    toObject() {
      ...
      if (this.defaults != null) {
        data.defaults = this.defaults.map(
          (item: FeatureSetDefaults.FeatureSetEditionDefault) =>
            item.toObject(),
        );
      }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_minimum_edition) writer.writeEnum(4, this.minimum_edition);
      if (this.has_maximum_edition) writer.writeEnum(5, this.maximum_edition);
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(
      bytes: Uint8Array | pb_1.BinaryReader,
      ...
      const reader =
          bytes instanceof pb_1.BinaryReader
            ? bytes
            : new pb_1.BinaryReader(bytes),
        message = new FeatureSetDefaults();
      while (reader.nextField()) {
        if (reader.isEndGroup()) break;
        switch (reader.getFieldNumber()) {
          case 1:
            reader.readMessage(message.defaults, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                1,
                FeatureSetDefaults.FeatureSetEditionDefault.deserialize(reader),
                FeatureSetDefaults.FeatureSetEditionDefault,
              ),
            );
            break;
      ...
      static deserialize(
        ...
        const reader =
            bytes instanceof pb_1.BinaryReader
              ? bytes
              : new pb_1.BinaryReader(bytes),
          message = new FeatureSetEditionDefault();
        while (reader.nextField()) {
          if (reader.isEndGroup()) break;
          switch (reader.getFieldNumber()) {
            case 3:
  ...
  export class SourceCodeInfo extends pb_1.Message {
    ...
    static fromObject(data: {
      location?: ReturnType<
        typeof SourceCodeInfo.Location.prototype.toObject
      >[];
    }): SourceCodeInfo {
      const message = new SourceCodeInfo({
        location: data.location.map((item) =>
          SourceCodeInfo.Location.fromObject(item),
        ),
      });
      return message;
    }
    toObject() {
      ...
      if (this.location != null) {
        data.location = this.location.map((item: SourceCodeInfo.Location) =>
          item.toObject(),
        );
      }
      return data;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.location.length)
        writer.writeRepeatedMessage(
          1,
          this.location,
          (item: SourceCodeInfo.Location) => item.serialize(writer),
        );
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SourceCodeInfo {
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 1:
            reader.readMessage(message.location, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                1,
                SourceCodeInfo.Location.deserialize(reader),
                SourceCodeInfo.Location,
              ),
            );
            break;
    ...
    export class Location extends pb_1.Message {
      ...
      constructor(
        ...
        if (!Array.isArray(data) && typeof data == 'object') {
          ...
          this.span = data.span;
          if (
            'leading_comments' in data &&
            data.leading_comments != undefined
          ) {
            this.leading_comments = data.leading_comments;
          }
          if (
            'trailing_comments' in data &&
            data.trailing_comments != undefined
          ) {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.path.length) writer.writePackedInt32(1, this.path);
        if (this.span.length) writer.writePackedInt32(2, this.span);
  ...
  export class GeneratedCodeInfo extends pb_1.Message {
    ...
    get annotation() {
      return pb_1.Message.getRepeatedWrapperField(
        ...
        1,
      ) as GeneratedCodeInfo.Annotation[];
    }
    ...
    static fromObject(data: {
      annotation?: ReturnType<
        typeof GeneratedCodeInfo.Annotation.prototype.toObject
      >[];
    }): GeneratedCodeInfo {
      const message = new GeneratedCodeInfo({
        annotation: data.annotation.map((item) =>
          GeneratedCodeInfo.Annotation.fromObject(item),
        ),
      });
      return message;
    }
    toObject() {
      ...
      if (this.annotation != null) {
        data.annotation = this.annotation.map(
          (item: GeneratedCodeInfo.Annotation) => item.toObject(),
        );
      }
      return data;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.annotation.length)
        writer.writeRepeatedMessage(
          1,
          this.annotation,
          (item: GeneratedCodeInfo.Annotation) => item.serialize(writer),
        );
      if (!w) return writer.getResultBuffer();
    }
    static deserialize(
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 1:
            reader.readMessage(message.annotation, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                1,
                GeneratedCodeInfo.Annotation.deserialize(reader),
                GeneratedCodeInfo.Annotation,
              ),
            );
            break;
  ...
  export namespace GeneratedCodeInfo {
    export class Annotation extends pb_1.Message {
      ...
      get semantic() {
        ...
        ) as GeneratedCodeInfo.Annotation.Semantic;
      }
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.has_begin) writer.writeInt32(3, this.begin);
        if (this.has_end) writer.writeInt32(4, this.end);
        if (this.has_semantic) writer.writeEnum(5, this.semantic);
        if (!w) return writer.getResultBuffer();
      }
