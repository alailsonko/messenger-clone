...
export namespace google.api.expr.v1alpha1 {
  export class ParsedExpr extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_source_info)
        writer.writeMessage(3, this.source_info, () =>
          this.source_info.serialize(writer),
        );
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          case 2:
            reader.readMessage(
              message.expr,
              () => (message.expr = Expr.deserialize(reader)),
            );
            break;
          case 3:
            reader.readMessage(
              message.source_info,
              () => (message.source_info = SourceInfo.deserialize(reader)),
            );
            break;
          default:
            reader.skipField();
  ...
  export class Expr extends pb_1.Message {
    ...
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == 'object') {
        ...
        if (
          'comprehension_expr' in data &&
          data.comprehension_expr != undefined
        ) {
    ...
    static fromObject(data: {
      ...
      comprehension_expr?: ReturnType<
        typeof Expr.Comprehension.prototype.toObject
      >;
    }): Expr {
      ...
      if (data.comprehension_expr != null) {
        message.comprehension_expr = Expr.Comprehension.fromObject(
          data.comprehension_expr,
        );
      }
      return message;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.id != 0) writer.writeInt64(2, this.id);
      if (this.has_const_expr)
        writer.writeMessage(3, this.const_expr, () =>
          this.const_expr.serialize(writer),
        );
      if (this.has_ident_expr)
        writer.writeMessage(4, this.ident_expr, () =>
          this.ident_expr.serialize(writer),
        );
      if (this.has_select_expr)
        writer.writeMessage(5, this.select_expr, () =>
          this.select_expr.serialize(writer),
        );
      if (this.has_call_expr)
        writer.writeMessage(6, this.call_expr, () =>
          this.call_expr.serialize(writer),
        );
      if (this.has_list_expr)
        writer.writeMessage(7, this.list_expr, () =>
          this.list_expr.serialize(writer),
        );
      if (this.has_struct_expr)
        writer.writeMessage(8, this.struct_expr, () =>
          this.struct_expr.serialize(writer),
        );
      if (this.has_comprehension_expr)
        writer.writeMessage(9, this.comprehension_expr, () =>
          this.comprehension_expr.serialize(writer),
        );
      if (!w) return writer.getResultBuffer();
    }
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 3:
            reader.readMessage(
              message.const_expr,
              () => (message.const_expr = Constant.deserialize(reader)),
            );
            break;
          case 4:
            reader.readMessage(
              message.ident_expr,
              () => (message.ident_expr = Expr.Ident.deserialize(reader)),
            );
            break;
          case 5:
            reader.readMessage(
              message.select_expr,
              () => (message.select_expr = Expr.Select.deserialize(reader)),
            );
            break;
          case 6:
            reader.readMessage(
              message.call_expr,
              () => (message.call_expr = Expr.Call.deserialize(reader)),
            );
            break;
          case 7:
            reader.readMessage(
              message.list_expr,
              () => (message.list_expr = Expr.CreateList.deserialize(reader)),
            );
            break;
          case 8:
            reader.readMessage(
              message.struct_expr,
              () =>
                (message.struct_expr = Expr.CreateStruct.deserialize(reader)),
            );
            break;
          case 9:
            reader.readMessage(
              message.comprehension_expr,
              () =>
                (message.comprehension_expr =
                  Expr.Comprehension.deserialize(reader)),
            );
            break;
          default:
            reader.skipField();
  ...
  export namespace Expr {
    export class Ident extends pb_1.Message {
      ...
      static fromObject(data: { name?: string }): Ident {
    ...
    export class Select extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.has_operand)
          writer.writeMessage(1, this.operand, () =>
            this.operand.serialize(writer),
          );
        if (this.field.length) writer.writeString(2, this.field);
        if (this.test_only != false) writer.writeBool(3, this.test_only);
        if (!w) return writer.getResultBuffer();
      }
        ...
        while (reader.nextField()) {
          ...
          switch (reader.getFieldNumber()) {
            case 1:
              reader.readMessage(
                message.operand,
                () => (message.operand = Expr.deserialize(reader)),
              );
              break;
            case 2:
    ...
    export class Call extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.has_target)
          writer.writeMessage(1, this.target, () =>
            this.target.serialize(writer),
          );
        if (this.function.length) writer.writeString(2, this.function);
        if (this.args.length)
          writer.writeRepeatedMessage(3, this.args, (item: Expr) =>
        ...
        while (reader.nextField()) {
          ...
          switch (reader.getFieldNumber()) {
            case 1:
              reader.readMessage(
                message.target,
                () => (message.target = Expr.deserialize(reader)),
              );
              break;
            case 2:
    ...
    export class CreateList extends pb_1.Message {
      ...
      constructor(
        ...
        if (!Array.isArray(data) && typeof data == 'object') {
          ...
          if (
            'optional_indices' in data &&
            data.optional_indices != undefined
          ) {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.elements.length)
          writer.writeRepeatedMessage(1, this.elements, (item: Expr) =>
            item.serialize(writer),
          );
    ...
    export class CreateStruct extends pb_1.Message {
      ...
      static fromObject(data: {
        message_name?: string;
        entries?: ReturnType<
          typeof Expr.CreateStruct.Entry.prototype.toObject
        >[];
      }): CreateStruct {
        ...
        if (data.entries != null) {
          message.entries = data.entries.map((item) =>
            Expr.CreateStruct.Entry.fromObject(item),
          );
        }
        return message;
      }
      toObject() {
        ...
        if (this.entries != null) {
          data.entries = this.entries.map((item: Expr.CreateStruct.Entry) =>
            item.toObject(),
          );
        }
        return data;
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.message_name.length) writer.writeString(1, this.message_name);
        if (this.entries.length)
          writer.writeRepeatedMessage(
            2,
            this.entries,
            (item: Expr.CreateStruct.Entry) => item.serialize(writer),
          );
        if (!w) return writer.getResultBuffer();
      }
        ...
        while (reader.nextField()) {
          ...
          switch (reader.getFieldNumber()) {
            case 1:
              ...
              break;
            case 2:
              reader.readMessage(message.entries, () =>
                pb_1.Message.addToRepeatedWrapperField(
                  message,
                  2,
                  Expr.CreateStruct.Entry.deserialize(reader),
                  Expr.CreateStruct.Entry,
                ),
              );
              break;
    ...
    export namespace CreateStruct {
      export class Entry extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
          ...
          if (this.has_field_key) writer.writeString(2, this.field_key);
          if (this.has_map_key)
            writer.writeMessage(3, this.map_key, () =>
              this.map_key.serialize(writer),
            );
          if (this.has_value)
            writer.writeMessage(4, this.value, () =>
          ...
          while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
              ...
              case 3:
                reader.readMessage(
                  message.map_key,
                  () => (message.map_key = Expr.deserialize(reader)),
                );
                break;
              case 4:
                reader.readMessage(
                  message.value,
                  () => (message.value = Expr.deserialize(reader)),
                );
                break;
              case 5:
    ...
    export class Comprehension extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.iter_var.length) writer.writeString(1, this.iter_var);
        if (this.has_iter_range)
          writer.writeMessage(2, this.iter_range, () =>
            this.iter_range.serialize(writer),
          );
        if (this.accu_var.length) writer.writeString(3, this.accu_var);
        if (this.has_accu_init)
          writer.writeMessage(4, this.accu_init, () =>
            this.accu_init.serialize(writer),
          );
        if (this.has_loop_condition)
          writer.writeMessage(5, this.loop_condition, () =>
            this.loop_condition.serialize(writer),
          );
        if (this.has_loop_step)
          writer.writeMessage(6, this.loop_step, () =>
            this.loop_step.serialize(writer),
          );
        if (this.has_result)
          writer.writeMessage(7, this.result, () =>
        ...
        while (reader.nextField()) {
          ...
          switch (reader.getFieldNumber()) {
            ...
            case 2:
              reader.readMessage(
                message.iter_range,
                () => (message.iter_range = Expr.deserialize(reader)),
              );
              break;
            case 3:
            ...
            case 4:
              reader.readMessage(
                message.accu_init,
                () => (message.accu_init = Expr.deserialize(reader)),
              );
              break;
            case 5:
              reader.readMessage(
                message.loop_condition,
                () => (message.loop_condition = Expr.deserialize(reader)),
              );
              break;
            case 6:
              reader.readMessage(
                message.loop_step,
                () => (message.loop_step = Expr.deserialize(reader)),
              );
              break;
            case 7:
              reader.readMessage(
                message.result,
                () => (message.result = Expr.deserialize(reader)),
              );
              break;
            default:
              reader.skipField();
  ...
  export class Constant extends pb_1.Message {
    ...
    get null_value() {
      return pb_1.Message.getFieldWithDefault(
        this,
        1,
        dependency_2.google.protobuf.NullValue.NULL_VALUE,
      ) as dependency_2.google.protobuf.NullValue;
    }
    ...
    get duration_value() {
      return pb_1.Message.getWrapperField(
        this,
        dependency_1.google.protobuf.Duration,
        8,
      ) as dependency_1.google.protobuf.Duration;
    }
    /** @deprecated*/
    ...
    static fromObject(data: {
      ...
      string_value?: string;
      bytes_value?: Uint8Array;
      duration_value?: ReturnType<
        typeof dependency_1.google.protobuf.Duration.prototype.toObject
      >;
      timestamp_value?: ReturnType<
      ...
      if (data.duration_value != null) {
        message.duration_value =
          dependency_1.google.protobuf.Duration.fromObject(data.duration_value);
      }
      if (data.timestamp_value != null) {
        message.timestamp_value =
          dependency_3.google.protobuf.Timestamp.fromObject(
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.has_null_value) writer.writeEnum(1, this.null_value);
      if (this.has_bool_value) writer.writeBool(2, this.bool_value);
      if (this.has_int64_value) writer.writeInt64(3, this.int64_value);
      if (this.has_uint64_value) writer.writeUint64(4, this.uint64_value);
      if (this.has_double_value) writer.writeDouble(5, this.double_value);
      if (this.has_string_value) writer.writeString(6, this.string_value);
      if (this.has_bytes_value) writer.writeBytes(7, this.bytes_value);
      if (this.has_duration_value)
        writer.writeMessage(8, this.duration_value, () =>
          this.duration_value.serialize(writer),
        );
      if (this.has_timestamp_value)
        writer.writeMessage(9, this.timestamp_value, () =>
          this.timestamp_value.serialize(writer),
        );
      if (!w) return writer.getResultBuffer();
    }
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 8:
            reader.readMessage(
              ...
              () =>
                (message.duration_value =
                  dependency_1.google.protobuf.Duration.deserialize(reader)),
            );
            break;
          case 9:
            reader.readMessage(
  ...
  export class SourceInfo extends pb_1.Message {
    ...
    constructor(
      ...
      if (!this.positions) this.positions = new Map();
      if (!this.macro_calls) this.macro_calls = new Map();
    }
    get syntax_version() {
      return pb_1.Message.getFieldWithDefault(this, 1, '') as string;
    }
    ...
    static fromObject(data: {
      ...
      if (typeof data.macro_calls == 'object') {
        message.macro_calls = new Map(
          Object.entries(data.macro_calls).map(([key, value]) => [
            Number(key),
            Expr.fromObject(value),
          ]),
        );
      }
      if (data.extensions != null) {
        message.extensions = data.extensions.map((item) =>
          SourceInfo.Extension.fromObject(item),
        );
      }
      return message;
    }
    toObject() {
      const data: {
        ...
        extensions?: ReturnType<
          typeof SourceInfo.Extension.prototype.toObject
        >[];
      } = {};
      ...
      if (this.macro_calls != null) {
        data.macro_calls = Object.fromEntries(
          Array.from(this.macro_calls).map(([key, value]) => [
            key,
            value.toObject(),
          ]),
        );
      ...
      if (this.extensions != null) {
        data.extensions = this.extensions.map((item: SourceInfo.Extension) =>
          item.toObject(),
        );
      }
      return data;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.location.length) writer.writeString(2, this.location);
      ...
      if (this.extensions.length)
        writer.writeRepeatedMessage(
          6,
          this.extensions,
          (item: SourceInfo.Extension) => item.serialize(writer),
        );
      if (!w) return writer.getResultBuffer();
    }
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 5:
            ...
            break;
          case 6:
            reader.readMessage(message.extensions, () =>
              pb_1.Message.addToRepeatedWrapperField(
                message,
                6,
                SourceInfo.Extension.deserialize(reader),
                SourceInfo.Extension,
              ),
            );
            break;
  ...
  export namespace SourceInfo {
    export class Extension extends pb_1.Message {
      ...
      constructor(
        ...
        if (!Array.isArray(data) && typeof data == 'object') {
          ...
          if (
            'affected_components' in data &&
            data.affected_components != undefined
          ) {
      ...
      get affected_components() {
        return pb_1.Message.getFieldWithDefault(
          ...
          2,
          [],
        ) as SourceInfo.Extension.Component[];
      }
      ...
      get version() {
        return pb_1.Message.getWrapperField(
          ...
          3,
        ) as SourceInfo.Extension.Version;
      }
      ...
      static fromObject(data: {
        ...
        affected_components?: SourceInfo.Extension.Component[];
        version?: ReturnType<
          typeof SourceInfo.Extension.Version.prototype.toObject
        >;
      }): Extension {
        ...
        if (data.version != null) {
          message.version = SourceInfo.Extension.Version.fromObject(
            data.version,
          );
        }
        return message;
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.has_version)
          writer.writeMessage(3, this.version, () =>
          ...
          switch (reader.getFieldNumber()) {
            ...
            case 3:
              reader.readMessage(
                ...
                () =>
                  (message.version =
                    SourceInfo.Extension.Version.deserialize(reader)),
              );
              break;
            default:
              reader.skipField();
    ...
    export namespace Extension {
      ...
      export class Version extends pb_1.Message {
        ...
        static fromObject(data: { major?: number; minor?: number }): Version {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
          const writer = w || new pb_1.BinaryWriter();
          if (this.major != 0) writer.writeInt64(1, this.major);
          if (this.minor != 0) writer.writeInt64(2, this.minor);
          if (!w) return writer.getResultBuffer();
        }
  ...
  export class SourcePosition extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.offset != 0) writer.writeInt32(2, this.offset);
      if (this.line != 0) writer.writeInt32(3, this.line);
      if (this.column != 0) writer.writeInt32(4, this.column);
      if (!w) return writer.getResultBuffer();
    }
