...
export namespace google.protobuf {
  ...
  export class Value extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_number_value) writer.writeDouble(2, this.number_value);
      if (this.has_string_value) writer.writeString(3, this.string_value);
      if (this.has_bool_value) writer.writeBool(4, this.bool_value);
      if (this.has_struct_value)
        writer.writeMessage(5, this.struct_value, () =>
          this.struct_value.serialize(writer),
        );
      if (this.has_list_value)
        writer.writeMessage(6, this.list_value, () =>
          this.list_value.serialize(writer),
        );
      if (!w) return writer.getResultBuffer();
    }
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 5:
            reader.readMessage(
              ...
              () => (message.struct_value = Struct.deserialize(reader)),
            );
            break;
          case 6:
            reader.readMessage(
              message.list_value,
              () => (message.list_value = ListValue.deserialize(reader)),
            );
            break;
          default:
            reader.skipField();
  ...
  export class ListValue extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.values.length)
        writer.writeRepeatedMessage(1, this.values, (item: Value) =>
