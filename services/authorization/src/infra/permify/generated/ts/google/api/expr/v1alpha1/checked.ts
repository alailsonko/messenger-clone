...
export namespace google.api.expr.v1alpha1 {
  export class CheckedExpr extends pb_1.Message {
    ...
    constructor(
      ...
      if (!this.reference_map) this.reference_map = new Map();
      if (!this.type_map) this.type_map = new Map();
    }
    get reference_map() {
    ...
    get source_info() {
      return pb_1.Message.getWrapperField(
        this,
        dependency_1.google.api.expr.v1alpha1.SourceInfo,
        5,
      ) as dependency_1.google.api.expr.v1alpha1.SourceInfo;
    }
    ...
    get expr() {
      return pb_1.Message.getWrapperField(
        this,
        dependency_1.google.api.expr.v1alpha1.Expr,
        4,
      ) as dependency_1.google.api.expr.v1alpha1.Expr;
    }
    ...
    static fromObject(data: {
      ...
      source_info?: ReturnType<
        typeof dependency_1.google.api.expr.v1alpha1.SourceInfo.prototype.toObject
      >;
      expr_version?: string;
      expr?: ReturnType<
        typeof dependency_1.google.api.expr.v1alpha1.Expr.prototype.toObject
      >;
    }): CheckedExpr {
      const message = new CheckedExpr({});
      if (typeof data.reference_map == 'object') {
        message.reference_map = new Map(
          Object.entries(data.reference_map).map(([key, value]) => [
            Number(key),
            Reference.fromObject(value),
          ]),
        );
      }
      if (typeof data.type_map == 'object') {
        message.type_map = new Map(
          Object.entries(data.type_map).map(([key, value]) => [
            Number(key),
      ...
      if (data.source_info != null) {
        message.source_info =
          dependency_1.google.api.expr.v1alpha1.SourceInfo.fromObject(
            data.source_info,
          );
      }
      ...
      if (data.expr != null) {
        message.expr = dependency_1.google.api.expr.v1alpha1.Expr.fromObject(
          data.expr,
        );
      }
      return message;
    ...
    toObject() {
      ...
      if (this.reference_map != null) {
        data.reference_map = Object.fromEntries(
          Array.from(this.reference_map).map(([key, value]) => [
            key,
            value.toObject(),
          ]),
        );
      ...
      if (this.type_map != null) {
        data.type_map = Object.fromEntries(
          Array.from(this.type_map).map(([key, value]) => [
            key,
            value.toObject(),
          ]),
        );
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_source_info)
        writer.writeMessage(5, this.source_info, () =>
          this.source_info.serialize(writer),
        );
      if (this.expr_version.length) writer.writeString(6, this.expr_version);
      if (this.has_expr)
        ...
        switch (reader.getFieldNumber()) {
            ...
            reader.readMessage(message, () =>
              pb_1.Map.deserializeBinary(
                ...
                () => {
                  ...
                  reader.readMessage(
                    message,
                    () => (value = Reference.deserialize(reader)),
                  );
                  return value;
                },
              ),
          ...
          case 5:
            reader.readMessage(
              ...
              () =>
                (message.source_info =
                  dependency_1.google.api.expr.v1alpha1.SourceInfo.deserialize(
                    reader,
                  )),
            );
            break;
          ...
          case 4:
            reader.readMessage(
              ...
              () =>
                (message.expr =
                  dependency_1.google.api.expr.v1alpha1.Expr.deserialize(
                    reader,
                  )),
            );
            break;
  ...
  export class Type extends pb_1.Message {
    ...
    get dyn() {
      return pb_1.Message.getWrapperField(
        ...
        1,
      ) as dependency_2.google.protobuf.Empty;
    }
    ...
    get null() {
      return pb_1.Message.getFieldWithDefault(
        this,
        2,
        dependency_3.google.protobuf.NullValue.NULL_VALUE,
      ) as dependency_3.google.protobuf.NullValue;
    }
    ...
    get primitive() {
      return pb_1.Message.getFieldWithDefault(
        this,
        3,
        Type.PrimitiveType.PRIMITIVE_TYPE_UNSPECIFIED,
      ) as Type.PrimitiveType;
    }
    ...
    get well_known() {
      return pb_1.Message.getFieldWithDefault(
        this,
        5,
        Type.WellKnownType.WELL_KNOWN_TYPE_UNSPECIFIED,
      ) as Type.WellKnownType;
    }
    ...
    static fromObject(data: {
      dyn?: ReturnType<
        typeof dependency_2.google.protobuf.Empty.prototype.toObject
      >;
      null?: dependency_3.google.protobuf.NullValue;
      primitive?: Type.PrimitiveType;
      wrapper?: Type.PrimitiveType;
      ...
      if (data.error != null) {
        message.error = dependency_2.google.protobuf.Empty.fromObject(
          data.error,
        );
      }
      if (data.abstract_type != null) {
        message.abstract_type = Type.AbstractType.fromObject(
          data.abstract_type,
        );
      }
      return message;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_null) writer.writeEnum(2, this.null);
      if (this.has_primitive) writer.writeEnum(3, this.primitive);
      if (this.has_wrapper) writer.writeEnum(4, this.wrapper);
      if (this.has_well_known) writer.writeEnum(5, this.well_known);
      if (this.has_list_type)
        writer.writeMessage(6, this.list_type, () =>
          this.list_type.serialize(writer),
        );
      if (this.has_map_type)
        writer.writeMessage(7, this.map_type, () =>
          this.map_type.serialize(writer),
        );
      if (this.has_function)
        writer.writeMessage(8, this.function, () =>
          this.function.serialize(writer),
        );
      if (this.has_message_type) writer.writeString(9, this.message_type);
      if (this.has_type_param) writer.writeString(10, this.type_param);
      if (this.has_type)
      ...
      if (this.has_abstract_type)
        writer.writeMessage(14, this.abstract_type, () =>
          this.abstract_type.serialize(writer),
        );
      if (!w) return writer.getResultBuffer();
    }
        ...
        switch (reader.getFieldNumber()) {
          case 1:
            reader.readMessage(
              ...
              () =>
                (message.dyn =
                  dependency_2.google.protobuf.Empty.deserialize(reader)),
            );
            break;
          case 2:
          ...
          case 6:
            reader.readMessage(
              message.list_type,
              () => (message.list_type = Type.ListType.deserialize(reader)),
            );
            break;
          case 7:
            reader.readMessage(
              message.map_type,
              () => (message.map_type = Type.MapType.deserialize(reader)),
            );
            break;
          case 8:
            reader.readMessage(
              message.function,
              () => (message.function = Type.FunctionType.deserialize(reader)),
            );
            break;
          case 9:
          ...
          case 11:
            reader.readMessage(
              message.type,
              () => (message.type = Type.deserialize(reader)),
            );
            break;
          case 12:
            reader.readMessage(
          ...
          case 14:
            reader.readMessage(
              message.abstract_type,
              () =>
                (message.abstract_type = Type.AbstractType.deserialize(reader)),
            );
            break;
          default:
            reader.skipField();
    ...
    export class ListType extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.has_elem_type)
          writer.writeMessage(1, this.elem_type, () =>
            this.elem_type.serialize(writer),
          );
        if (!w) return writer.getResultBuffer();
      }
        ...
        while (reader.nextField()) {
          ...
          switch (reader.getFieldNumber()) {
            case 1:
              reader.readMessage(
                message.elem_type,
                () => (message.elem_type = Type.deserialize(reader)),
              );
              break;
            default:
              reader.skipField();
    ...
    export class MapType extends pb_1.Message {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.has_key_type)
          writer.writeMessage(1, this.key_type, () =>
            this.key_type.serialize(writer),
          );
        if (this.has_value_type)
          writer.writeMessage(2, this.value_type, () =>
            this.value_type.serialize(writer),
          );
        if (!w) return writer.getResultBuffer();
      }
        ...
        while (reader.nextField()) {
          ...
          switch (reader.getFieldNumber()) {
            case 1:
              reader.readMessage(
                message.key_type,
                () => (message.key_type = Type.deserialize(reader)),
              );
              break;
            case 2:
              reader.readMessage(
                message.value_type,
                () => (message.value_type = Type.deserialize(reader)),
              );
              break;
            default:
              reader.skipField();
    ...
    export class FunctionType extends pb_1.Message {
      ...
      static fromObject(data: {
        ...
        if (data.arg_types != null) {
          message.arg_types = data.arg_types.map((item) =>
            Type.fromObject(item),
          );
        }
        return message;
      }
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.has_result_type)
          writer.writeMessage(1, this.result_type, () =>
            this.result_type.serialize(writer),
          );
        if (this.arg_types.length)
          writer.writeRepeatedMessage(2, this.arg_types, (item: Type) =>
        ...
        while (reader.nextField()) {
          ...
          switch (reader.getFieldNumber()) {
            case 1:
              reader.readMessage(
                message.result_type,
                () => (message.result_type = Type.deserialize(reader)),
              );
              break;
            case 2:
              reader.readMessage(message.arg_types, () =>
    ...
    export class AbstractType extends pb_1.Message {
      ...
      static fromObject(data: {
        ...
        if (data.parameter_types != null) {
          message.parameter_types = data.parameter_types.map((item) =>
            Type.fromObject(item),
          );
        }
        return message;
      ...
      toObject() {
        ...
        if (this.parameter_types != null) {
          data.parameter_types = this.parameter_types.map((item: Type) =>
            item.toObject(),
          );
        }
        return data;
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.parameter_types.length)
          writer.writeRepeatedMessage(2, this.parameter_types, (item: Type) =>
            item.serialize(writer),
          );
        if (!w) return writer.getResultBuffer();
      }
        ...
        while (reader.nextField()) {
          ...
          switch (reader.getFieldNumber()) {
            case 1:
              ...
              break;
            case 2:
              reader.readMessage(message.parameter_types, () =>
                pb_1.Message.addToRepeatedWrapperField(
                  message,
                  2,
                  Type.deserialize(reader),
  ...
  export class Decl extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_function)
        writer.writeMessage(3, this.function, () =>
          this.function.serialize(writer),
        );
      if (!w) return writer.getResultBuffer();
    }
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 2:
            reader.readMessage(
              message.ident,
              () => (message.ident = Decl.IdentDecl.deserialize(reader)),
            );
            break;
          case 3:
            reader.readMessage(
              message.function,
              () => (message.function = Decl.FunctionDecl.deserialize(reader)),
            );
            break;
          default:
            reader.skipField();
  ...
  export namespace Decl {
    export class IdentDecl extends pb_1.Message {
      ...
      get value() {
        return pb_1.Message.getWrapperField(
          this,
          dependency_1.google.api.expr.v1alpha1.Constant,
          2,
        ) as dependency_1.google.api.expr.v1alpha1.Constant;
      }
      ...
      static fromObject(data: {
        type?: ReturnType<typeof Type.prototype.toObject>;
        value?: ReturnType<
          typeof dependency_1.google.api.expr.v1alpha1.Constant.prototype.toObject
        >;
        doc?: string;
      }): IdentDecl {
        ...
        if (data.value != null) {
          message.value =
            dependency_1.google.api.expr.v1alpha1.Constant.fromObject(
              data.value,
            );
        }
        if (data.doc != null) {
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.doc.length) writer.writeString(3, this.doc);
        if (!w) return writer.getResultBuffer();
      }
          ...
          switch (reader.getFieldNumber()) {
            ...
            case 2:
              reader.readMessage(
                ...
                () =>
                  (message.value =
                    dependency_1.google.api.expr.v1alpha1.Constant.deserialize(
                      reader,
                    )),
              );
              break;
    ...
    export class FunctionDecl extends pb_1.Message {
      ...
      static fromObject(data: {
        overloads?: ReturnType<
          typeof Decl.FunctionDecl.Overload.prototype.toObject
        >[];
      }): FunctionDecl {
        const message = new FunctionDecl({});
        if (data.overloads != null) {
          message.overloads = data.overloads.map((item) =>
            Decl.FunctionDecl.Overload.fromObject(item),
          );
        }
        return message;
      }
      toObject() {
        ...
        if (this.overloads != null) {
          data.overloads = this.overloads.map(
            (item: Decl.FunctionDecl.Overload) => item.toObject(),
          );
        }
        return data;
      }
      ...
      serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.overloads.length)
          writer.writeRepeatedMessage(
            1,
            this.overloads,
            (item: Decl.FunctionDecl.Overload) => item.serialize(writer),
          );
        if (!w) return writer.getResultBuffer();
      }
      static deserialize(bytes: Uint8Array | pb_1.BinaryReader): FunctionDecl {
        const reader =
            bytes instanceof pb_1.BinaryReader
              ? bytes
              : new pb_1.BinaryReader(bytes),
          message = new FunctionDecl();
        while (reader.nextField()) {
          if (reader.isEndGroup()) break;
          switch (reader.getFieldNumber()) {
            case 1:
              reader.readMessage(message.overloads, () =>
                pb_1.Message.addToRepeatedWrapperField(
                  message,
                  1,
                  Decl.FunctionDecl.Overload.deserialize(reader),
                  Decl.FunctionDecl.Overload,
                ),
              );
              break;
      ...
      export class Overload extends pb_1.Message {
        ...
        constructor(
          ...
          if (!Array.isArray(data) && typeof data == 'object') {
            ...
            if (
              'is_instance_function' in data &&
              data.is_instance_function != undefined
            ) {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
          const writer = w || new pb_1.BinaryWriter();
          if (this.overload_id.length) writer.writeString(1, this.overload_id);
          if (this.params.length)
            writer.writeRepeatedMessage(2, this.params, (item: Type) =>
              item.serialize(writer),
            );
          if (this.type_params.length)
            writer.writeRepeatedString(3, this.type_params);
          if (this.has_result_type)
            writer.writeMessage(4, this.result_type, () =>
              this.result_type.serialize(writer),
            );
          if (this.is_instance_function != false)
            writer.writeBool(5, this.is_instance_function);
          if (this.doc.length) writer.writeString(6, this.doc);
          if (!w) return writer.getResultBuffer();
        }
  ...
  export class Reference extends pb_1.Message {
    ...
    static fromObject(data: {
      ...
      if (data.value != null) {
        message.value =
          dependency_1.google.api.expr.v1alpha1.Constant.fromObject(data.value);
      }
      return message;
    }
    toObject() {
